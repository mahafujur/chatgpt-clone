...
import {MdDelete, MdOutlineVpnKey,} from 'react-icons/md';
...
const LeftMenu = () => {
    ...
    const hasOpenApiKey = readFromLocalStorage(LOCAL_STORAGE.API_KEY)
    ...
    return (
        <section
            id={'device-size-detector'}
            className={`${
                open ? 'w-72' : 'w-16'
            } bg-background flex flex-col items-center gap-y-4 h-screen pt-4 relative duration-100 shadow-md`}>
            <div className='flex items-center justify-between w-full px-2 mx-auto cursor-pointer'>
                <div
                    className={` ${
                        !open && 'scale-0 hidden'
                    } flex flex-row items-center gap-2 mx-auto w-full justify-between`}>
                    <div className={'flex gap-x-2 items-center'}>

                        <svg viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg"
                             className="size-5 " role="img">
                        ...
                        <h1 className={'text-black text-base font-semibold '}>New Chat</h1>
                    </div>
            ...
            {hasOpenApiKey ? null : <ul className='absolute bottom-0 w-full gap-1 menu rounded-box'>
                <li>
                    <a onClick={() => setModalOpen(true)}>
                        ...
                        <p className={`${!open && 'hidden'}`}>Add Key</p>
                    </a>
                </li>
            </ul>}
            <UserAvatar/>
